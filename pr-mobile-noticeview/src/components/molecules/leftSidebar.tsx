...
import MasterDelete from "@/components/atoms/masterDelete";
const LeftSidebar = () => {
  const darkMode = useDarkMode(false);
  const { visibleLeft, setVisible, user } = useContext(GetContext);
    ...
    <div className={`fancy-selector-w`}>
      ...
      >
        ...
        <DarkModeToggle
          ...
          size={80}
        />
        {user === null ? null : user.email === "master@master.com" ? (
          <MasterDelete />
        ) : null}
      </Sidebar>
    </div>
