...
const LogInForm = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      icon: "pi pi-sign-in",
      command: () => {
        const user = users.find((user) => user.email === "demo1@demo1.com");
        setLogin(user);
    ...
    },
    {
      ...
      icon: "pi pi-sign-in",
      command: () => {
        const user = users.find((user) => user.email === "demo2@demo2.com");
        setLogin(user);
    ...
    },
    {
      ...
      icon: "pi pi-sign-in",
      command: () => {
        const user = users.find((user) => user.email === "demo3@demo3.com");
        setLogin(user);
